...
#elif defined(STM32F4) || defined(STM32F7) || defined(STM32H7) || defined(STM32H5) || defined(STM32G4)
...
typedef struct transponder_s {
    ...
    #if defined(STM32F4)|| defined(STM32F7) || defined(STM32H7) || defined(STM32H5) || defined(STM32G4) || defined(UNIT_TEST)
